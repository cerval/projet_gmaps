...
--
-- Client: localhost
-- Généré le: Sam 28 Mars 2015 à 13:48
-- Version du serveur: 5.5.9-log
...
--
-- Structure de la table `_badges`
--

CREATE TABLE IF NOT EXISTS `_badges` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idUser` int(11) NOT NULL,
  `idComment` int(11) NOT NULL,
  `type` enum('plus','minus') COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `_badges`
--

INSERT INTO `_badges` (`id`, `idUser`, `idComment`, `type`, `created`, `enable`) VALUES
(1, 1, 3, 'plus', '2015-02-10 18:12:34', 1),
(2, 1, 1, 'minus', '2015-02-10 18:33:33', 1),
(3, 2, 1, 'plus', '2015-02-10 19:57:29', 1);
...
--
-- Contenu de la table `_comments`
--

INSERT INTO `_comments` (`id`, `idUser`, `idItem`, `comment`, `created`, `enable`) VALUES
(1, 1, 14, '', '2015-02-10 17:59:52', 1),
(2, 1, 1, 'Encore une victoire de canard !', '2015-02-10 21:14:04', 1);
...
(15, 1, 2, 'aaa', 'zzz', '48.910761', '2.1802633', '2015-03-11 20:33:40', 1);
...
--
-- Contenu de la table `_notes`
--

INSERT INTO `_notes` (`id`, `idUser`, `idItem`, `note`, `created`, `enable`) VALUES
(0, 1, 14, 3, '2015-02-10 17:59:52', 1);
